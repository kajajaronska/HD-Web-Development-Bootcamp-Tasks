// Pseudocode:
// Create prompt for the user to enter name of the city | For development purposes create a variable with a static city name i.e. "johannesburg"

// let userCityChoice = prompt("Please enter name of the city:")

let userCityChoice = "Johannesburg";
