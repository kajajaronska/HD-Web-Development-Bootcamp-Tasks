disappearString = (myString, toErase) => {
    // Converting toErase string to an array of characters
    let toEraseArr = toErase.split("");

    // Looping through toEraseArr to remove every letter from myString
    toEraseArr.forEach(letter => {
